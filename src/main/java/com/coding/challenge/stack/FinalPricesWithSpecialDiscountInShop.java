...
class FinalPricesWithSpecialDiscountInShop {
	...
	public static void main(String[] args) {
		...
		final int[] a1 = { 4, 2, 4, 2, 3 };
		assert Arrays.equals(a1, finalPrices(prices1));

		final int[] prices2 = { 1, 2, 3, 4, 5 };
		final int[] a2 = { 1, 2, 3, 4, 5 };
		assert Arrays.equals(a2, finalPrices(prices2));

		final int[] prices3 = { 10, 1, 1, 6 };
		final int[] a3 = { 9, 0, 1, 6 };
		assert Arrays.equals(a3, finalPrices(prices3));
	}
